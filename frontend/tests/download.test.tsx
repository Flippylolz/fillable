...
const item: Resource = { id: "id", kind: "document", title: "Заява", original_filename: "Заява-Їжак.docx", current_version_id: "v1", created_at: "2026-09-06", updated_at: "2026-09-06", size_bytes: 3, digest: "hash", unsupported_count: 0, processing_status: "not_started", preview_ready: false, deletion_pending: false };

...
- One page with **Templates** and **Documents** galleries switched from the sidebar sections. Documents contains individual working copies and saved processed results.
...
- A two-mode view switch: **Document** mode shows the editor canvas and sidebar for selecting fields; **Fill** mode shows a filling form of the already-selected fields with compact inputs, text-formatting controls and a large live document preview. Modes share one draft, undo history and save path.
